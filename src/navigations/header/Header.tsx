...
const HeaderRightButton = ({navigation}) => {
  ...
  return (
      <TouchableOpacity style={{flexDirection:'row'}}
        onPress={GotoRoute}
      >
        <Icon type="material" name="edit" size={25}  style={{ color: '#fff', marginRight: 20 }} />
        <Icon type="Entypo" name="dots-three-vertical" size={25}  style={{ color: '#fff', marginRight: 10 }} />
      </TouchableOpacity>
    );
};

const StackHeader = ({route}:any) => {
